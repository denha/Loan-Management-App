...
&nbsp;&nbsp;<label>Branch </label>&nbsp;<input  class='easyui-combobox ' style="width:13%;height:34px;"  name='company' 
id='company' />
...
@endif 
<label>Name</label>
<input class="easyui-combobox" style="width:18%" id="product" name="product" data-options="url:'customerscombo',valueField:'id',textField:'name',method:'get' "/>
&nbsp;
<label>Product</label>
...
$('#company').combobox({
  ...
  onSelect:function(rec){
    ...
    $('#product').combobox('reload', '/customerscomboBranch/'+rec.id);
  }
