...
<table class='easyui-datagrid' striped="true" showFooter="true" title='Final Loan Approvals' iconCls='fa fa-table' singleSelect='true' url='listloanapprovalfinal' pagination='true' id='gridsuppliers' method='get' fitColumns='true'  rownumbers='true' style='width:100%' toolbar='#supplierstoolbar'>
<thead><tr>
...
<th field='approveamt' width='50'>Approved Loan Amt</th>
...
$('#loansch').click(function(){
    ...
    window.open('/applicationlistfinal/'+a.id);
    }
