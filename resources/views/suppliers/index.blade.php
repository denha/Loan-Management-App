...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guarantors Agreement Page 1</label></div>
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guarantors Agreement Page 2</label></div>
 <div id="form-attachmen">
   <input  name="agreement2" id="agreement2"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guarantors Agreement Page 3</label></div>
 <div id="form-attachmen">
   <input  name="agreement3" id="agreement3"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guarantors Agreement Page 4</label></div>
 <div id="form-attachmen">
   <input  name="agreement4" id="agreement4"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Guarantors Agreement Page 5</label></div>
 <div id="form-attachmen">
   <input  name="agreement5" id="agreement5"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>
<div class='col-lg-6'>
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Chairman Consent Letter </label></div>
 <div id="form-attachmen">
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>LC1 page 2 </label></div>
 <div id="form-attachmen">
   <input  name="chairman2" id="chairman2"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>LC1 page 3 </label></div>
 <div id="form-attachmen">
   <input  name="chairman3" id="chairman3"   style="height:34px;width:100%" class="easyui-filebox form-control" />
</div>
</div>
</div>-->
<div class='col-lg-6'>
...
var agr2 = $('#agreement2').next().find('.textbox-value');
var agr3 = $('#agreement3').next().find('.textbox-value');
var pro = $('#proof').next().find('.textbox-value');
var cha = $('#chairman').next().find('.textbox-value');
var agr4 = $('#agreement4').next().find('.textbox-value');
var agr5 = $('#agreement5').next().find('.textbox-value');
...
form_data.append('agreement2', agr2[0].files[0]);
form_data.append('agreement3', agr3[0].files[0]);
form_data.append('agreement4', agr4[0].files[0]);
form_data.append('agreement5', agr5[0].files[0]);
					...
					if($(this).form('validate')==true){
                        if(validate==true){
                            if(typeof agr[0].files[0]==='undefined'){
                                $.messager.alert('Warning','Agreement page 1 must be attached','warning');
                            }
                            else if(typeof agr2[0].files[0]==='undefined'){
                                $.messager.alert('Warning','Agreement page 2 must be attached','warning');
                            }
                            else if(typeof agr3[0].files[0]==='undefined'){
                                $.messager.alert('Warning','Agreement page 3 must be attached','warning');
                                ...
                                $.messager.alert('Warning','Chairman Consent Letter must be attached ','warning');
                            }
                            else if(typeof agr4[0].files[0]==='undefined'){
                                $.messager.alert('Warning','Agreement page 4 must be attached ','warning');
                            }
                            else if(typeof agr5[0].files[0]==='undefined'){
                                $.messager.alert('Warning','Agreement page 5 must be attached ','warning');
                            }
