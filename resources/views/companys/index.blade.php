...
<div id='companystoolbar'>
@if(Auth::user()->branchid==1)
<a href='javascript:void(0)' class='btn btn-primary' id='newcompanys' iconCls='icon-edit' ><i class="fa fa-plus-circle" aria-hidden="true"></i>New</a>
@endif
<a href='javascript:void(0)' class='btn btn-primary' id='editcompanys' iconCls='icon-edit' ><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
@if(Auth::user()->branchid==1)
<a href='javascript:void(0)' class='btn btn-primary' id='deletecompanys' iconCls='icon-edit' ><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>&nbsp;
@endif
