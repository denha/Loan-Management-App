...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Share Amt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Bal :</b><b id="shar"></b></label></div><input required style="width:100%;height:34px" type='text' class='easyui-textbox form-control' name='shares' 
 id='shares' /></div>
 </div>
 <div class='col-lg-6'>
<div class='form-group'>
