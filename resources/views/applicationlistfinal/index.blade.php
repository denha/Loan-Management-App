...
<input id="officername" type="hidden" value="{{$officername}}" />
<input id="officerid" type="hidden" value="{{$officeid}}" />
<!--<input type="hidden"  class='easyui-textbox form-control' style="height:34px;width:100%;"  name='loanidf' 
 id='loanno' />-->
</form>
</div>
...
<div class='form-group'>
<div><label>Loan Officer</label></div><input  required class='easyui-textbox form-control' style="height:34px;width:100%;"  name='name' 
 id='loanofficerrjt' readonly/></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
...
$('#savesuppliers').click(function(){
	...
	$.ajax({
                 ...
                 success:function(){
					 window.location='/finalloanapproval';
