...
public function getApprovedAmt($id){
    return DB::select("select id as  appid, format(approveamt,0)approveamt,intmethod,mode,period,loanrepay,loaninterest from loaninfos where memeberid=$id and isApprove=4");
}
